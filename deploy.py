...
print(f"curl -X POST \"https://[API_ID].execute-api.eu-west-1.amazonaws.com/prod/anuncios/[ID_DEL_ANUNCIO]/comentarios\" -H \"Content-Type: application/json\" -d \"{{\\\"usuario\\\": \\\"Maria\\\", \\\"mensaje\\\": \\\"¿Podría ver el coche este fin de semana?\\\"}}\"")
