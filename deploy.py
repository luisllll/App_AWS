...
print(f"curl -X POST \"https://[API_ID].execute-api.eu-west-1.amazonaws.com/prod/anuncios/[ID_DEL_ANUNCIO]/comentarios\" -H \"Content-Type: application/json\" -d \"{{\\\"usuario\\\": \\\"pepe\\\", \\\"mensaje\\\": \\\"comentario de prueba de pepe\\\"}}\"")
